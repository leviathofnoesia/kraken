...
describe('grep-app MCP', () => {
  ...
  describe('MCP server definition', () => {
    ...
    it('has configuration schema', () => {
      ...
      expect(grepAppMCP.configSchema?.githubToken).toBe(
        'string (optional, GitHub personal access token)',
      )
  ...
  describe('tool definitions', () => {
    ...
    it('has search tool', () => {
      // #given
      const searchTool = grepAppMCP.tools.find((t) =>
        t.description.toLowerCase().includes('search code'),
      )
